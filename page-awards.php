        ...
        <div class="f--row">
            ...
            if ($awards_query->have_posts()) {
                ...
                foreach ($awards_by_year as $year => $awards) {
                    $is_active = in_array($year, $latest_years) ? 'g--accordion-02__hd--is-active' : '';
                    $is_bdActive = in_array($year, $latest_years) ? 'g--accordion-02__bd--is-active' : '';
                    $is_ariaExpanded = in_array($year, $latest_years) ? 'true' : 'false';
                    $is_ariaHidden = in_array($year, $latest_years) ? 'false' : 'true';

                    if ($year >= 2021) { ?>
                        <div class="f--col-12">
                            <div class="g--accordion-02 g--accordion-02--fifth  js--accordion-02" closeOthers="false">
                                <button class="g--accordion-02__hd <?php echo $is_active; ?>" type="button" data-accordion02-control="acc-0<?= $year?>" aria-expanded="<?php echo $is_ariaExpanded; ?>">
                                    <span class="g--accordion-02__hd__item-primary"><?php echo $year; ?></span>
                                    <span class="g--accordion-02__hd__icon" role="presentation"></span>
                                </button>
                                <div class="g--accordion-02__bd <?php echo $is_bdActive; ?>" data-accordion02-content="acc-0<?= $year?>" aria-hidden="<?php echo $is_ariaHidden; ?>">
                    ...
                    <?php } else { $archive_awards[] = $awards; }
                    }
                    if (!empty($archive_awards)) {?>
                        <div class="f--col-12">
                            <div class="g--accordion-02 g--accordion-02--fifth  js--accordion-02" closeOthers="false">
                                <button class="g--accordion-02__hd" type="button" data-accordion02-control="acc-0<?= $year?>" aria-expanded="false">
                                    <span class="g--accordion-02__hd__item-primary">2020 & Earlier</span>
                                    <span class="g--accordion-02__hd__icon" role="presentation"></span>
                                </button>
                                <div class="g--accordion-02__bd" data-accordion02-content="acc-0<?= $year?>" aria-hidden="true">
                                    <div class="g--accordion-02__bd__content">
                                        <div class="f--row f--row--remove-gutter">
