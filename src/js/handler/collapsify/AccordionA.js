...
class AccordionA {
    constructor(payload) {
        ...
        this.accordionItemsToShow = this.accordion.classList.contains("c--accordion-a--second")
    ...
    updateStyles() {
        ...
        if (window.innerWidth > 810) {
            this.content.forEach((content) => {
                ...
                u_take_your_time(10).then(() => {
                    //* we have to add the height when the width has already been applied to align all the buttons at bottom
