 ...
 */
class PREFIX_acf_field_message extends \acf_field {
	/**
	...
	public function __construct() {
		 ...
		 */
		$this->label = __( 'Section message', 'TEXTDOMAIN' );
	...
	public function input_admin_enqueue_scripts() {
		...
		wp_enqueue_script( 'PREFIX-message' );
		wp_enqueue_style( 'PREFIX-message' );
	}
}
