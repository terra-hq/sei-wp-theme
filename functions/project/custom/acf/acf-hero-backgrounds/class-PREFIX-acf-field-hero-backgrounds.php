 ...
 */
class PREFIX_acf_field_herobackgrounds extends \acf_field
{
    /**
    ...
    public function __construct()
    {
         ...
         */
        $this->label = __('Hero Background Color', 'TEXTDOMAIN');
    ...
    public function render_field($field)
    {
        ...
        <div class="dropdown-color js--background-hero">
            <div class="selected">
                <a href="#"><span>Please select</span></a>
            </div>
            <div class="options js--select-light-background-color">
                <ul>
                    <li value="primary"><a href="#" class="c--color-bg-a c--color-bg--red" data-value="f--background-f">
                            <div></div>Red
                        </a></li>
                    <li><a href="#" data-value="f--background-e" class="c--color-bg-a c--color-bg--purple--hero">
                        <div></div>Purple
                    </a></li>
                </ul>
            </div>
    ...
    public function input_admin_enqueue_scripts()
    {
        ...
        wp_enqueue_script('PREFIX-herobackgrounds');
        wp_enqueue_style('PREFIX-herobackgrounds');
    }
}
