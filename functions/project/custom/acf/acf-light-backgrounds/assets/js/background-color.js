...
(function ($) {
    ...
    function initialize_field($field) {
        ...
        $.each($($field.find(".js--background-color-light")), function () {
    ...
    if (typeof acf.add_action !== "undefined") {
         ...
         */
        acf.add_action("ready_field/type=lightbackgrounds", initialize_field);
        acf.add_action("append_field/type=lightbackgrounds", initialize_field);
    }
})(jQuery);
