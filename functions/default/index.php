...
require get_template_directory() . '/functions/default/blocks/block-footnote.php'; 
require get_template_directory() . '/functions/default/blocks/block-highlighted.php'; 
