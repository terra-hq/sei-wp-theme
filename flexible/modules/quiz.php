<section class="js--quiz-a u--pt-22 u--pb-22">
    <div class="f--container">
        <div class="f--row u--justify-content-center">
            <div class="f--col-5 f--col-desktop-6 f--col-tabletl-8 f--col-tabletm-12">

                <form class="c--quiz-a hs-form" action="#" method="post" novalidate>

                    <div class="c--quiz-a__hd">
                        <h1 class="c--quiz-a__hd__title">Talk to our experience team and discover your next step with AI</h1>
                    </div>
                    ...
                    <fieldset class="c--quiz-a__wrapper c--quiz-a__wrapper--is-active" data-step="1" data-tab-content="quiz-step-01" aria-hidden="false">
                        <div class="c--quiz-a__wrapper__hd">
                            <span class="c--quiz-a__wrapper__hd__item js--progressbar-text"></span>
                            <div class="c--quiz-a__wrapper__hd__wrapper js--progressbar-wrapper" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="0">
                                <span class="c--quiz-a__wrapper__hd__wrapper__item js--progressbar-item" aria-hidden="true"></span>
                            </div>
                        </div>
                    ...
                    <fieldset class="c--quiz-a__wrapper" data-step="4" data-tab-content="quiz-step-04" aria-hidden="true">
                        ...
                        <div class="c--quiz-a__wrapper__bd">
                            <div class="c--quiz-a__wrapper__bd__wrapper c--quiz-a__wrapper__bd__wrapper--second">
                                <h2 class="c--quiz-a__wrapper__bd__wrapper__title">Thank you</h2>
                                <p class="c--quiz-a__wrapper__bd__wrapper__text">Thank you for exploring your organization's AI readiness with us. We're looking forward to sharing what we've learned and how our AI expertise can help you take the next step.</p>
                            </div>
                        </div>
                    </fieldset>
