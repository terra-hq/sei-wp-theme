<section class="js--quiz-a u--pt-15">
    <div class="f--container">
        <div class="f--row u--justify-content-center">
            <div class="f--col-5 f--col-laptop-8 f--col-tabletm-12">
                    ...
                    <fieldset class="c--quiz-a__wrapper c--quiz-a__wrapper--is-active" data-step="1" data-tab-content="quiz-step-01" aria-hidden="false">
                        ...
                        <div class="c--quiz-a__wrapper__bd">
                            ...
                            <div class="c--quiz-a__wrapper__bd__wrapper">
                                ...
                                <div class="c--form-group-a">
                                    <label class="c--label-a" for="quiz-phone">Phone number</label>
                                    <div class="c--form-input-a">
                                        <input class="c--form-input-a__item" type="tel" name="phone" id="quiz-phone" placeholder="Your phone number" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <fieldset class="c--quiz-a__wrapper" data-step="2" data-tab-content="quiz-step-02" aria-hidden="true">
                        ...
                        <div class="c--quiz-a__wrapper__bd">
                            ...
                            <div class="c--quiz-a__wrapper__bd__wrapper">
                                ...
                                <div class="c--form-group-a">
                                    <label class="c--label-a" for="quiz-industry">What is your industry?*</label>
                                    <div class="c--form-select-a">
                        ...
                        <div class="c--quiz-a__wrapper__bd">
                            ...
                            <div class="c--quiz-a__wrapper__bd__wrapper">
                                <div class="c--form-group-a">
                                    ...
                                    <div class="c--form-select-a">
                                        <select class="c--form-select-a__item" name="challenge" id="quiz-challenge" required>
                                ...
                                <div class="c--form-group-a">
                                    ...
                                    <div class="c--form-input-a">
                                        <textarea class="c--form-input-a__item" name="message" id="quiz-message" placeholder="Your message"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
