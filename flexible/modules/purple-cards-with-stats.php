    ...
    <div class="f--container">
        <div class="f--row f--row--remove-gutter">
            ...
            <div class="f--col-4 f--col-tabletm-6 f--col-tablets-12 u--display-flex">
                <div class="c--stats-a">
                    <h3 class="c--stats-a__title "><?= $cards[0]['title'] ?></h3>
            ...
            <div class="f--col-4 f--col-tabletm-6 f--col-tablets-12 u--display-flex">
                <div class="c--stats-a c--stats-a--second">
                    <h3 class="c--stats-a__title "><?= $cards[1]['title'] ?></h3>
            ...
            <div class="f--col-4 f--col-tabletm-6 f--col-tablets-12 u--display-flex">
                <div class="c--stats-a c--stats-a--third">
                    <h3 class="c--stats-a__title "><?= $cards[2]['title'] ?></h3>
...
<?php unset($spacing, $bgColor, $cards); ?>