<nav class="c--social-a c--social-a--second">
        <a href="http://www.linkedin.com/shareArticle?mini=true&url=<?php echo get_the_permalink()?>&title=Check%20out%20this%20SEI%20insight" target="_blank" rel="noopener noreferrer" class="c--social-a__item" aria-label="linkedin">
        ...
        <a href="https://twitter.com/intent/tweet?url=<?php the_permalink() ?>&text=Check%20out%20this%20SEI%20insight" target="_blank" rel="noopener noreferrer" class="c--social-a__item" aria-label="twitter">
        ...
        <a href="mailto:?subject=Check out this SEI insight&amp;body=Check out this SEI insight <?php echo get_the_permalink()?>" target="_blank" rel="noopener noreferrer" class="c--social-a__item" aria-label="email">
            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="18" viewBox="0 0 26 18" fill="none">
                <path d="M7 5.28125L12.75 9.30625L18.5 5.28125" stroke="#F01840" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M1.54688 14.4816V2.98164C1.54688 1.71139 2.57662 0.681641 3.84687 0.681641H22.2469C23.5172 0.681641 24.5469 1.71139 24.5469 2.98164V14.4816C24.5469 15.7519 23.5172 16.7816 22.2469 16.7816H3.84687C2.57662 16.7816 1.54688 15.7519 1.54688 14.4816Z" stroke="#F01840"/>
            </svg>
        </a>
    <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo get_the_permalink()?>" target="_blank" rel="noopener noreferrer" class="c--social-a__item" aria-label="facebook">
